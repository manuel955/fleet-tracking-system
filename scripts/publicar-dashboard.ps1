...
$Dominio {
  ...
  header {
    ...
    Content-Security-Policy "default-src 'self'; base-uri 'self'; object-src 'none'; frame-ancestors 'none'; form-action 'self'; script-src 'self' https://www.gstatic.com https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://api.mapbox.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://api.mapbox.com; font-src 'self' data: https://fonts.gstatic.com; img-src 'self' data: blob: https://firebasestorage.googleapis.com https://api.tucomprass.com https://api.mapbox.com https://*.tiles.mapbox.com; connect-src 'self' https://api.tucomprass.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://*.googleapis.com https://*.firebaseio.com wss://*.firebaseio.com https://*.cloudfunctions.net https://api.mapbox.com https://events.mapbox.com https://*.tiles.mapbox.com; frame-src https://rastreoflota-53052.firebaseapp.com; worker-src 'self' blob: https://cdnjs.cloudflare.com"
  }
  file_server
}
