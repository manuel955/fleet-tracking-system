...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (_photo == null) {
      setState(() => _error = 'Toma o elige una foto de tu credencial (DNI/carnet).');
      return;
    }
    ...
    try {
      ...
      setState(() { _busy = false; _error = 'Error al registrar: $e'; });
    }
  }
        ...
        child: Form(
          ...
          child: ListView(
            ...
            children: [
              ...
              const Text('Foto de tu credencial (DNI/carnet)', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14.5)),
              const SizedBox(height: 10),
              if (_photo != null)
                ClipRRect(
                  borderRadius: BorderRadius.circular(12),
                  child: Image.file(File(_photo!.path), height: 170, width: double.infinity, fit: BoxFit.cover),
                )
              else
                Container(
                  height: 100,
                  ...
                  child: Icon(Icons.badge_outlined, color: Colors.grey.shade400, size: 32),
                ),
              const SizedBox(height: 10),
              Row(
                children: [
              ...
              ElevatedButton(
                ...
                child: _busy
                    ...
                    : const Text('Registrarme', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 15)),
              ),
            ],
          ),
        ),
