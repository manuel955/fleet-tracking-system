...
class PlaceSearchResult {
  ...
  final double lat;
  final double lng;
  PlaceSearchResult({required this.description, required this.lat, required this.lng});
}
  ...
  Future<void> _selectSuggestion(PlaceSuggestion suggestion) async {
    ...
    try {
      ...
      if (mounted) {
        Navigator.pop(
          context,
          PlaceSearchResult(description: suggestion.description, lat: latLng.lat, lng: latLng.lng),
        );
      }
    } catch (e) {
          ...
          Expanded(
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  leading: Icon(Icons.place_outlined, color: Colors.grey.shade600),
                  title: Text(s.description, style: const TextStyle(fontSize: 14.5)),
