...
/// Boton de soporte, pensado para estar siempre visible: al tocarlo deja
/// elegir entre llamar o escribir por WhatsApp. El numero se trae de
/// config/supportPhone (editable desde el dashboard, ver
/// SupportConfigService) en el momento de abrir la hoja, asi un cambio hecho
/// en el dashboard se ve sin necesidad de reabrir la app. Mismo widget que
/// driver-app/lib/widgets/support_button.dart.
